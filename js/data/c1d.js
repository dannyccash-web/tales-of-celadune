...
export default {
  ...
  obstacles: [
    ...
    { x: 0, y: 840, w: 1378, h: 40 },
    { x: 0, y: 880, w: 1370, h: 40 },
    { x: 0, y: 920, w: 1358, h: 40 },
    { x: 0, y: 960, w: 1350, h: 40 },
    { x: 0, y: 1000, w: 1342, h: 40 },
    { x: 0, y: 1040, w: 1338, h: 40 },
    { x: 0, y: 1080, w: 1322, h: 40 },
    { x: 0, y: 1120, w: 1326, h: 40 },
    { x: 0, y: 1160, w: 1314, h: 40 },
    { x: 0, y: 1200, w: 1318, h: 80 },
    { x: 0, y: 1280, w: 1314, h: 40 },
    { x: 0, y: 1320, w: 1310, h: 40 },
    { x: 0, y: 1360, w: 1294, h: 40 },
    { x: 0, y: 1400, w: 1306, h: 40 },
    { x: 0, y: 1440, w: 1298, h: 40 },
    { x: 0, y: 1480, w: 1306, h: 40 },
    { x: 0, y: 1520, w: 1290, h: 40 },
    { x: 0, y: 1560, w: 1306, h: 40 },
    { x: 0, y: 1600, w: 1302, h: 40 },
    { x: 0, y: 1640, w: 1306, h: 40 },
    { x: 0, y: 1680, w: 1310, h: 80 },
    { x: 0, y: 1760, w: 1306, h: 40 },
    { x: 0, y: 1800, w: 1318, h: 40 },
    { x: 0, y: 1840, w: 1310, h: 40 },
    { x: 0, y: 1880, w: 1326, h: 40 },
    { x: 0, y: 1920, w: 1318, h: 40 },
    { x: 0, y: 1960, w: 1334, h: 40 },
    { x: 0, y: 2000, w: 1326, h: 40 },
    { x: 0, y: 2040, w: 1350, h: 40 },
    { x: 0, y: 2080, w: 1354, h: 40 },
    { x: 0, y: 2120, w: 1366, h: 40 },
    { x: 0, y: 2160, w: 1358, h: 40 },
    { x: 0, y: 2200, w: 1386, h: 40 },
    { x: 0, y: 2240, w: 1402, h: 40 },
    { x: 0, y: 2280, w: 1418, h: 80 },
    { x: 0, y: 2360, w: 1458, h: 40 },
    { x: 0, y: 2400, w: 1482, h: 40 },
    { x: 0, y: 2440, w: 1502, h: 40 },
    { x: 0, y: 2480, w: 1514, h: 40 },
    { x: 0, y: 2520, w: 3000, h: 480 },

    { x: 1486, y: 560, w: 1514, h: 40 },
    { x: 1498, y: 600, w: 1502, h: 40 },
    { x: 1526, y: 640, w: 1474, h: 40 },
    { x: 1562, y: 680, w: 1438, h: 40 },
    { x: 1582, y: 720, w: 1418, h: 40 },
    { x: 1598, y: 760, w: 1402, h: 40 },
    { x: 1610, y: 800, w: 1390, h: 40 },
    { x: 1622, y: 840, w: 1378, h: 40 },
    { x: 1634, y: 880, w: 1366, h: 40 },
    { x: 1646, y: 920, w: 1354, h: 40 },
    { x: 1650, y: 960, w: 1350, h: 40 },
    { x: 1658, y: 1000, w: 1342, h: 40 },
    { x: 1666, y: 1040, w: 1334, h: 40 },
    { x: 1678, y: 1080, w: 1322, h: 40 },
    { x: 1674, y: 1120, w: 1326, h: 40 },
    { x: 1686, y: 1160, w: 1314, h: 40 },
    { x: 1682, y: 1200, w: 1318, h: 40 },
    { x: 1686, y: 1240, w: 1314, h: 40 },
    { x: 1690, y: 1280, w: 1310, h: 40 },
    { x: 1694, y: 1320, w: 1306, h: 40 },
    { x: 1710, y: 1360, w: 1290, h: 40 },
    { x: 1694, y: 1400, w: 1306, h: 40 },
    { x: 1706, y: 1440, w: 1294, h: 40 },
    { x: 1698, y: 1480, w: 1302, h: 40 },
    { x: 1714, y: 1520, w: 1286, h: 40 },
    { x: 1698, y: 1560, w: 1302, h: 40 },
    { x: 1702, y: 1600, w: 1298, h: 40 },
    { x: 1698, y: 1640, w: 1302, h: 40 },
    { x: 1694, y: 1680, w: 1306, h: 80 },
    ...
    { x: 1670, y: 1960, w: 1330, h: 40 },
    { x: 1678, y: 2000, w: 1322, h: 40 },
    { x: 1654, y: 2040, w: 1346, h: 40 },
    { x: 1646, y: 2080, w: 1354, h: 40 },
    { x: 1638, y: 2120, w: 1362, h: 40 },
    { x: 1642, y: 2160, w: 1358, h: 40 },
    { x: 1614, y: 2200, w: 1386, h: 40 },
    { x: 1598, y: 2240, w: 1402, h: 40 },
    { x: 1582, y: 2280, w: 1418, h: 80 },
    { x: 1542, y: 2360, w: 1458, h: 40 },
    { x: 1522, y: 2400, w: 1478, h: 40 },
    { x: 1498, y: 2440, w: 1502, h: 40 },
    { x: 1486, y: 2480, w: 1514, h: 40 },

    // Internal notches (crate/beam set dressing within the main span)
    { x: 1404, y: 760, w: 36, h: 40 },
    { x: 1496, y: 760, w: 36, h: 40 },
    { x: 1468, y: 840, w: 52, h: 40 },
    { x: 1512, y: 840, w: 40, h: 40 },
    { x: 1392, y: 840, w: 44, h: 80 },
    { x: 1448, y: 1960, w: 104, h: 40 },
    { x: 1388, y: 2080, w: 148, h: 40 },
    { x: 1524, y: 2080, w: 92, h: 40 },
    { x: 1404, y: 2160, w: 36, h: 40 },
    { x: 1472, y: 2200, w: 80, h: 80 },
    { x: 1552, y: 2240, w: 36, h: 40 },
  ],
