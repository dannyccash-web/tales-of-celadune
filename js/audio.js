...
export const DIALOGUE_SFX = {
  ...
  // same D2 pool rather than sourcing new audio — a species/faction shares
  // one clip (all 6 Bramblekin get the goblin-cackle, same idea as Vozhik),
  // individuals get one of the 4 male / 4 female "reaction" clips, spread
  // for variety.
  //
  // 2026-09-09 fix (Danny): that "4th male clip" was male_hurt7 — the SAME
  // file as SFX.hurt (the player-damage cue) — so talking to calder_rusk,
  // skitter_nabbins, or cade_fathom played the player's own hurt sound.
  // SFX.hurt must be exclusive to the player; all three were reassigned to
  // one of the other 3 male clips instead. Only 3 male clips remain in
  // active rotation now (M1/M2/M3 below), not 4.
  calder_rusk: 'assets/audio/mrstokes302-hmmm-sound-male-sfx-mrstokes302-420028.mp3', // D1, gruff old pirate
  ...
  // C1 Tidewrack Harbor (2026-09-03) — 8 men across the male clips, 4 women
  // across the 4 distinct female clips. skitter_nabbins/cade_fathom moved
  // off male_hurt7 on 2026-09-09 (see comment above); C1 now uses only 3
  // of the male clips (M1/M2/M3), unevenly split (3/3/2), not 4.
