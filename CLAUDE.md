...
- The pen itself is hollow, not solid: 4 thin (25px) fence rects around the x1050-1250, y1000-1300 footprint, with a clear interior at x1075-1225, y1025-1275 for Gaffer (the goat) to wander in. Keep any future pen edits hollow the same way — a solid pen rect would trap Gaffer's patrol targets inside an obstacle.
